...
import { Menu, LogOut, Bell, CheckCircle, XCircle } from 'lucide-react';
    ...
    <Popover>
      ...
      <PopoverContent align="end" className="w-80 p-0 overflow-hidden rounded-2xl shadow-2xl border-border">
        ...
        <div className="max-h-[400px] overflow-y-auto">
          {unreadMessages > 0 && (
            <div className="p-4 flex items-start gap-3 hover:bg-muted/50 cursor-pointer" onClick={() => navigate('/vendor/messages')}>
          ...
          <header className="sticky top-0 z-40 bg-white/80 backdrop-blur-md border-b border-sidebar-border px-4 py-3 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div className="hidden lg:block">
                <h2 className="text-xs font-black uppercase tracking-[0.2em] text-muted-foreground">Operational Environment</h2>
              </div>
            </div>
